...
/**
 * Adapted from smsc95xx.h by Juan Gonzalez <juan.gonzalez@technica-engineering.de> (2017-10-05)
 * Updated by Antonio Grau <antonio.grau@technica-engineering.de> (2018-4-08)
 * Updated by Patrik Thunström (2019-02-06)
 */

#ifndef _TECHNICABR_PRIV_H
#define _TECHNICABR_PRIV_H
...
#define PHY_INT_SRC_RDB_REG			(0x0a)
#define PHY_INT_SRC_RDB_ENERGY_ON_		(1<<15)
#define PHY_INT_SRC_RDB_LINK_CHANGED_		(1<<1)
...
#define PHY_INT_MASK_RDB_REG			(0x0b)
#define PHY_INT_MASK_RDB_ENERGY_ON_		(1<<15)
#define PHY_INT_MASK_RDB_LINK_CHANGED_       (1<<1)
#define PHY_INT_MASK_RDB_DEFAULT_	(PHY_INT_MASK_RDB_LINK_CHANGED_)
...
#define PHY_RDB_ADDR_REG 0x1e
#define PHY_RDB_DATA_REG 0x1f

#define PHY_LRE_CONTROL_REG 0
#define PHY_LRE_CONTROL_RESET (1 << 15)
#define PHY_LRE_CONTROL_SPEED_100 (1 << 9)
#define PHY_LRE_CONTROL_MASTER (1<<3)

#define PHY_LRE_STATUS_REG 0
#define PHY_LRE_STATUS_LINK_STATUS (1<<2)

#endif /* _TECHNICABR_PRIV_H */
